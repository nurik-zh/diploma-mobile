      ...
      <View style={styles.content}>
        <View style={[styles.headerCard, elevation]}>
          ...
          <Text style={styles.hSub}>
            ...
            оценивается моделью и сохраняется в профиле. После «Начать тест» вопросы подгружает ИИ — на экране
            оценки подождите несколько секунд или обновите список, если блоки пустые.
          </Text>
        </View>
